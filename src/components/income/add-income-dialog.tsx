...
export function AddIncomeDialog({ isOpen, onClose, categories, accounts, currency = 'BRL' }: AddIncomeDialogProps) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Adicionar Nova Receita">
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        placeholder="Ex: Salário, Venda de Ações"
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            <option value="" className="bg-card text-white">Aluguel Recebido</option>
                            {categories.map(c => (
                ...
                {/* Conta de Destino */}
                <div className="space-y-2">
                    <label className="text-sm font-medium text-white">Conta de Destino</label>
                    <select
                        required
                    ...
                    >
                        <option value="" className="bg-card text-white">Main</option>
                        {accounts.map(a => (
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-white">Receita Recorrente</p>
                            <p className="text-xs text-muted-foreground mt-0.5">Esta receita se repete mensalmente?</p>
                        </div>
                        <button
                            type="button"
                            role="switch"
