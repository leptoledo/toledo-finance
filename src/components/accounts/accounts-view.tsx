        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <Button
                    ...
                    className="w-full sm:w-auto bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-white shadow-lg shadow-yellow-500/50 transition-all hover-lift"
                >
                ...
                <div className="group relative overflow-hidden rounded-2xl glass border border-yellow-500/20 hover-lift">
                    ...
                    <div className="relative p-6">
                        <div className="flex items-center justify-between mb-4">
                            <div className="p-3 rounded-xl bg-gradient-to-br from-yellow-500 to-amber-600 shadow-lg shadow-yellow-500/50">
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-yellow-500/5 to-transparent pointer-events-none" />
                </div>
            ...
            {accounts.length > 0 ? (
                ...
                <div className="relative overflow-hidden rounded-2xl glass border border-yellow-500/20 p-12">
                    ...
                    <div className="relative text-center space-y-4">
                        <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-yellow-500 to-amber-600 shadow-lg shadow-yellow-500/50">
