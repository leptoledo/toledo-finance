        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
                ...
                <div className="relative overflow-hidden rounded-2xl glass border border-blue-500/20">
                    <div className="absolute inset-0 bg-linear-to-br from-blue-500/5 via-cyan-500/5 to-transparent" />
                    <div className="relative p-6 sm:p-8">
                        <div className="flex items-start gap-3 mb-6">
                            <div className="p-2 rounded-lg bg-linear-to-br from-blue-500 to-cyan-600 shadow-lg shadow-blue-500/50">
